...
public class BossComponent(BossModule module)
{
    ...
    public virtual bool KeepOnPhaseChange { get; set; } = false; // by default, all components are deactivated on phase change automatically (since phase change can happen at any time) - setting this to true prevents this
