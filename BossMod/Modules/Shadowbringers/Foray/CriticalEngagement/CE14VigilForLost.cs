...
class LightLeap(BossModule module) : Components.SimpleAOEs(module, (uint)AID.LightLeap, 10f);
class ChemicalMissile(BossModule module) : Components.SimpleAOEs(module, (uint)AID.ChemicalMissile, 12f);
class TailMissile(BossModule module) : Components.SimpleAOEs(module, (uint)AID.TailMissileAOE, 30f);
class Shockwave(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Shockwave, 16f);
class ExplosiveFlare(BossModule module) : Components.SimpleAOEs(module, (uint)AID.ExplosiveFlare, 10f);
class CripplingBlow(BossModule module) : Components.SingleTargetCast(module, (uint)AID.CripplingBlow);
class PlasmaField(BossModule module) : Components.RaidwideCast(module, (uint)AID.PlasmaField);
class Towers(BossModule module) : Components.CastTowersOpenWorld(module, (uint)AID.Explosion, 6f);
class MagitekRay(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MagitekRay, new AOEShapeRect(50f, 2f));
