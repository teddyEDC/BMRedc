...
class RightArmComet(BossModule module, AID aid, float distance) : Components.SimpleKnockbacks(module, ActionID.MakeSpell(aid), distance, shape: new AOEShapeCircle(_radius))
{
