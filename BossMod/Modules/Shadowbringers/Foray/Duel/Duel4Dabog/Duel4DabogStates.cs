...
class Duel4DabogStates : StateMachineBuilder
{
    ...
    private void SinglePhase(uint id)
    {
        ...
        Cast(id + 0x300000, (uint)AID.Enrage, 4.4f, 10, "Enrage");
    }

    private void LSlash(uint id, float delay)
    {
        Cast(id, (uint)AID.LeftArmSlash, delay, 3, "Cleave")
    ...
    {
        Cast(id, (uint)AID.RightArmComet, delay, 5);

        CastStart(id + 0x100, (uint)AID.LeftArmMetalCutter, 6.1f)
    ...
    {
        Cast(id, (uint)AID.LeftArmLimitCut, delay, 4);
        Cast(id + 0x10, (uint)AID.RightArmRayNormal, 3.3f, 4)
            .ActivateOnEnter<RightArmRayNormal>(); // aoes start ~0.8s after cast end
        Cast(id + 0x20, (uint)AID.LeftArmMetalCutter, 3.5f, 5)
    ...
    {
        Cast(id, (uint)AID.RightArmLimitCut, delay, 4);
        Cast(id + 0x10, (uint)AID.RightArmComet, 3.3f, 5);

        CastStart(id + 0x100, (uint)AID.LeftArmMetalCutter, 5.9f)
    ...
    {
        Cast(id, (uint)AID.CellDivision, delay, 4); // first pair starts cast 9.2s after this cast end, second pair starts 21.3s after this cast end
        ...
        CastStart(id + 0x11, (uint)AID.LeftArmMetalCutter, 3.2f);
    ...
    {
        Cast(id, (uint)AID.LeftArmWave, delay, 5, "Large aoe bait");
        ...
        Cast(id + 0x100, (uint)AID.RightArmBlasterBoss, 0.2f, 4, "Cleave")
    ...
    {
        Cast(id, (uint)AID.LeftArmLimitCut, delay, 4);
        Cast(id + 0x10, (uint)AID.ArmUnit, 3.5f, 5)
            .ActivateOnEnter<LeftArmMetalCutterAOE>()
            .ActivateOnEnter<LeftArmMetalCutterKnockbackLong>()
    ...
    {
        Cast(id, (uint)AID.RightArmLimitCut, delay, 4);
        Cast(id + 0x10, (uint)AID.ArmUnit, 4.6f, 5)
            .ActivateOnEnter<LeftArmMetalCutterAOE>()
            .ActivateOnEnter<LeftArmMetalCutterKnockbackShort>()
    ...
    {
        Cast(id, (uint)AID.RightArmLimitCut, delay, 4);
        Cast(id + 0x10, (uint)AID.RightArmRayBuffed, 3.2f, 4);
