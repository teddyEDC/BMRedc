...
class OptimalOffensiveSword(BossModule module) : Components.ChargeAOEs(module, (uint)AID.OptimalOffensiveSword, 2.5f);
class OptimalOffensiveShield(BossModule module) : Components.ChargeAOEs(module, (uint)AID.OptimalOffensiveShield, 2.5f);

// note: there are two casters (as usual in bozja content for raidwides)
class OptimalOffensiveShieldKnockback(BossModule module) : Components.SimpleKnockbacks(module, (uint)AID.OptimalOffensiveShieldKnockback, 10, true, 1);
