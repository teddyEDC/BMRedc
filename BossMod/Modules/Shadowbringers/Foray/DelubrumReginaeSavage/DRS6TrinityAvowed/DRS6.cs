...
class WrathOfBozjaBow(BossModule module) : Components.CastSharedTankbuster(module, (uint)AID.WrathOfBozjaBow, new AOEShapeCone(60f, 45f.Degrees())); // TODO: verify angle
