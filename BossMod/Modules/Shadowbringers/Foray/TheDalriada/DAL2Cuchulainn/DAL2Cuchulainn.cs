...
class NecroticBillowAOE(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.NecroticBillowAOE), 8);
class AmbientPulsationAOE(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.AmbientPulsationAOE), 12);

class FellFlow1(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.FellFlow1), new AOEShapeCone(50, 60.Degrees()));
