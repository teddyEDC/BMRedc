namespace BossMod.Shadowbringers.Quest.Role.TheLostAndTheFound.Sophrosyne;
...
class Charge(BossModule module) : Components.ChargeAOEs(module, (uint)AID.Charge, 2);
