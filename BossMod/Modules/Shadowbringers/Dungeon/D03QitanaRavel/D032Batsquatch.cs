...
{
    private static readonly ArenaBounds arena = new ArenaBoundsComplex([new Circle(new(62, -35.2f), 14.7f)], [new Rectangle(new(61.9f, -20), 20, 2), new Rectangle(new(61.9f, -50), 20, 2)]);
}
