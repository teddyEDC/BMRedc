...
class MechanicalDissection(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.MechanicalDissection), new AOEShapeRect(85, 5.5f));
class MechanicalDecapitation(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.MechanicalDecapitation), new AOEShapeDonut(8, 43));
class MechanicalContusionGround(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.MechanicalContusionGround), 6);
...
class IncongruousSpinAOE(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.IncongruousSpinAOE), new AOEShapeRect(80, 75));
