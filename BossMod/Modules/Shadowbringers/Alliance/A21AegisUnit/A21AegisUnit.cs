...
class FlightPath(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.FlightPath), new AOEShapeRect(60, 5));
...
class LifesLastSong(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.LifesLastSong), new AOEShapeCone(30, 50.Degrees()));
