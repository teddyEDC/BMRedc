...
class FlightPath(BossModule module) : Components.SimpleAOEs(module, (uint)AID.FlightPath, new AOEShapeRect(60, 5));
class AntiPersonnelLaser(BossModule module) : Components.SpreadFromCastTargets(module, (uint)AID.AntiPersonnelLaser, 6);
class HighPoweredLaser(BossModule module) : Components.StackWithCastTargets(module, (uint)AID.HighPoweredLaser, 6, 8);
class LifesLastSong(BossModule module) : Components.SimpleAOEs(module, (uint)AID.LifesLastSong, new AOEShapeCone(30, 50.Degrees()));
