...
public class Apomnemoneumata(BossModule module) : Components.CastCounter(module, (uint)AID.ApomnemoneumataNormal);

public class Phlegethon(BossModule module) : Components.SimpleAOEs(module, (uint)AID.PhlegetonAOE, 5);
