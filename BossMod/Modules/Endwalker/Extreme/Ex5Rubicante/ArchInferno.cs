...
class InfernoDevilFirst(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.InfernoDevilFirst), 10);
class InfernoDevilRest(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.InfernoDevilRest), 10);
class Conflagration(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.Conflagration), new AOEShapeRect(20, 5));
