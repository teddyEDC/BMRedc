...
class ShatteringHeatBoss(BossModule module) : Components.SpreadFromCastTargets(module, ActionID.MakeSpell(AID.ShatteringHeatBoss), 4f);
class BlazingRapture(BossModule module) : Components.CastCounter(module, ActionID.MakeSpell(AID.BlazingRaptureAOE));
class InfernoSpread(BossModule module) : Components.SpreadFromCastTargets(module, ActionID.MakeSpell(AID.InfernoSpreadAOE), 5f);
