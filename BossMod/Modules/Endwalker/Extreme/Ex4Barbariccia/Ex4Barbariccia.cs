...
class SecretBreezeCones(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.SecretBreezeAOE), new AOEShapeCone(40, 22.5f.Degrees()));
...
class WarningGale(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.WarningGale), 6);
...
class TornadoChainInner(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.TornadoChainInner), 11);
class TornadoChainOuter(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.TornadoChainOuter), new AOEShapeDonut(11, 20));
