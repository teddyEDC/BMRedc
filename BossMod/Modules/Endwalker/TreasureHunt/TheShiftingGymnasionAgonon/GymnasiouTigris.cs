...
public enum AID : uint
{
    ...
    HeavySmash = 32317 // BonusAddLyssa/BossAdd->location, 3.0s cast, range 6 circle
}
...
public class Tigris(WorldState ws, Actor primary) : BossModule(ws, primary, new(100, 100), new ArenaBoundsCircle(19))
{
