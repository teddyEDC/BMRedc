...
class DoubledImpact(BossModule module) : Components.CastSharedTankbuster(module, (uint)AID.DoubledImpact, 6);
class SewageEruption(BossModule module) : Components.SimpleAOEs(module, (uint)AID.SewageEruptionAOE, 6);
