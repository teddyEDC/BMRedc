...
class RayOfLight(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.RayOfLight), new AOEShapeRect(60, 5));
class UltimaBlade(BossModule module) : Components.CastCounter(module, ActionID.MakeSpell(AID.UltimaBladeAOE));
class Parthenos(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.Parthenos), new AOEShapeRect(60, 8, 60));
