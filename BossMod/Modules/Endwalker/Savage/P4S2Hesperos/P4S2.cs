...
class DemigodDouble(BossModule module) : Components.CastSharedTankbuster(module, (uint)AID.DemigodDouble, 6);

// state related to heart stake mechanic (dual hit tankbuster with bleed)
// TODO: consider showing some tank swap / invul hint...
class HeartStake(BossModule module) : Components.CastCounter(module, (uint)AID.HeartStakeSecond);
