...
//Left Windy
class WindblossomWhirl2(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.WindblossomWhirl2), new AOEShapeDonut(5, 60));
class WindblossomWhirl3(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.WindblossomWhirl3), new AOEShapeDonut(5, 60));
