...
class A33OschonStates : StateMachineBuilder
{
    ...
    {
        ActorCast(id, _module.BossP1, (uint)AID.SuddenDownpour, delay, 4, true);
    ...
    {
        ActorCastMulti(id, _module.BossP1, [(uint)AID.TrekShotN, (uint)AID.TrekShotS], delay, 6, true)
    ...
    {
        ActorCast(id, _module.BossP1, (uint)AID.Reproduce, delay, 3, true);
    ...
    {
        ActorCastStart(id, _module.BossP1, (uint)AID.FlintedFoehnP1, delay, true)
    ...
    {
        ActorCast(id, _module.BossP1, (uint)AID.SoaringMinuet1, delay, 5, true, "Wide cone")
    ...
    {
        ActorCast(id, _module.BossP1, (uint)AID.ArrowP1, delay, 4, true)
    ...
    {
        ActorCast(id, _module.BossP1, (uint)AID.DownhillP1, delay, 3, true);
        ComponentCondition<P1Downhill>(id + 0x10, 0.4f, comp => comp.Casters.Count > 0)
            .ActivateOnEnter<P1Downhill>();
        ActorCastMulti(id + 0x20, _module.BossP1, [(uint)AID.ClimbingShot1, (uint)AID.ClimbingShot2, (uint)AID.ClimbingShot3, (uint)AID.ClimbingShot4], 1.7f, 5, true, "Knockback")
        ...
        ActorCast(id + 0x100, _module.BossP1, (uint)AID.SoaringMinuet2, 1.3f, 5, true, "Wide cone")
    ...
    {
        ActorCast(id, _module.BossP1, (uint)AID.LoftyPeaks, delay, 5, true, "Boss disappears")
    ...
    {
        ActorCastMulti(id, _module.BossP2, [(uint)AID.PitonPullNW, (uint)AID.PitonPullNE], delay, 8, true)
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.Altitude, delay, 6, true)
    ...
    {
        ActorCastStart(id, _module.BossP2, (uint)AID.FlintedFoehnP2, delay, true)
    ...
    {
        ActorCastMulti(id, _module.BossP2, [(uint)AID.WanderingShotN, (uint)AID.WanderingShotS], delay, 7, true)
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.ArrowP2, delay, 6, true)
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.ArrowTrail, delay, 3, true);
        ...
        ActorCastStartMulti(id + 0x41, _module.BossP2, [(uint)AID.PitonPullNW, (uint)AID.PitonPullNE], 2.1f, true);
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.WanderingVolleyDownhill, delay, 3, true);
        ...
        ActorCastMulti(id + 0x20, _module.BossP2, [(uint)AID.WanderingVolleyN, (uint)AID.WanderingVolleyS], 2.7f, 10, true, "Knockback sides")
        ...
        ActorCastStartMulti(id + 0x40, _module.BossP2, [(uint)AID.PitonPullNW, (uint)AID.PitonPullNE], 1.9f, true);
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.P2SuddenDownpour, delay, 4, true);
