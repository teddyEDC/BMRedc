...
class P1Downhill(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.DownhillP1AOE), 6);
...
class P2PitonPull(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.PitonPullAOE), 22);
class P2Altitude(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.AltitudeAOE), 6);
