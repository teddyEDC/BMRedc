...
{
    private static readonly WPos[] vertices = [new(-29.2f, 235.5f), new(-40.3f, 248f), new(-47.5f, 260), new(-52.64f, 274.2f), new(-46.3f, 276.04f), new(-45.1f, 274.8f),
    ...
    new(-22.35f, 306.16f), new(-19.8f, 290.5f), new(-18, 288.7f), new(-16, 289.2f), new(-14, 290.9f), new(-13.9f, 303.98f), new(-6.23f, 304.72f), new(-4.5f, 288.2f),
