...
class RhalgrBeaconAOE(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.RhalgrsBeaconAOE), 10);
...
class RhalgrBeaconKnockback(BossModule module) : Components.SimpleKnockbacks(module, ActionID.MakeSpell(AID.RhalgrsBeaconKnockback), 50, true, stopAfterWall: true, safeWalls: safewalls)
{
