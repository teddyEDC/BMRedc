...
class WardensWarmth(BossModule module) : Components.BaitAwayCast(module, ActionID.MakeSpell(AID.WardensWarmthAOE), new AOEShapeCircle(6f), true, tankbuster: true);
class FleetingSpark(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.FleetingSpark), new AOEShapeCone(60f, 135f.Degrees()));
class SolarFold(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.SolarFoldAOE), new AOEShapeCross(30f, 5f));
class Sunbeam(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.Sunbeam), 9f, 14);
