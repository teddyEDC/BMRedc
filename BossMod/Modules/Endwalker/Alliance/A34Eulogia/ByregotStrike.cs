...
class ByregotStrikeCone(BossModule module) : Components.SelfTargetedAOEs(module, ActionID.MakeSpell(AID.ByregotStrikeAOE), new AOEShapeCone(90, 22.5f.Degrees()));
