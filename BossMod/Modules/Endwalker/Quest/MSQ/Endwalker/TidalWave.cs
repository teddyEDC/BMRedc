...
class TidalWave(BossModule module) : Components.KnockbackFromCastTarget(module, ActionID.MakeSpell(AID.TidalWaveVisual), 25f, kind: Kind.DirForward, stopAtWall: true)
{
