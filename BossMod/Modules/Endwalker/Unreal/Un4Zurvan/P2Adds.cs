...
class P2Comet(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Comet, 4);
class P2MeracydianFear(BossModule module) : Components.CastGaze(module, (uint)AID.MeracydianFear);
