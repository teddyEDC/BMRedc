...
{
    private static readonly ArenaBounds arena = new ArenaBoundsComplex([new Circle(new(350, -394), 19.5f)], [new Rectangle(new(350, -373), 20, 2.25f), new Rectangle(new(350, -414), 20, 1.25f)]);
}
