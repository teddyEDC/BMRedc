...
class CleaveCommon(BossModule module, uint aid, float hitboxRadius) : Components.Cleave(module, aid, new AOEShapeCone(6 + hitboxRadius, 60.Degrees()), activeWhileCasting: false);
class CleaveADS(BossModule module) : CleaveCommon(module, (uint)AID.CleaveADS, 2.3f);
class CleaveNode(BossModule module) : CleaveCommon(module, (uint)AID.CleaveNode, 1.15f);
...
class Firestream(BossModule module) : Components.SimpleAOEs(module, (uint)AID.FirestreamAOE, new AOEShapeRect(35.5f, 3));
class Ballast1(BossModule module) : Components.SimpleAOEs(module, (uint)AID.BallastAOE1, new AOEShapeCone(5.5f, 135.Degrees()));
class Ballast2(BossModule module) : Components.SimpleAOEs(module, (uint)AID.BallastAOE2, new AOEShapeDonutSector(5.5f, 10.5f, 135.Degrees()));
class Ballast3(BossModule module) : Components.SimpleAOEs(module, (uint)AID.BallastAOE3, new AOEShapeDonutSector(10.5f, 15.5f, 135.Degrees()));
