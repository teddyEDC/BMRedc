...
class Aura(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Aura, 8);
class VileUtterance(BossModule module) : Components.SimpleAOEs(module, (uint)AID.VileUtterance, new AOEShapeCone(30, 22.5f.Degrees()));
