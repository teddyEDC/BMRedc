...
class Aura(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.Aura), 8);
class VileUtterance(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.VileUtterance), new AOEShapeCone(30, 22.5f.Degrees()));
