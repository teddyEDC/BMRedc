...
class KnucklePress(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.KnucklePress), 10);
...
class AuraCannon(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.AuraCannon), new AOEShapeRect(60, 5));
