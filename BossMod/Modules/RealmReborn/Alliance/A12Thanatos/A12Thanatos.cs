...
class BlackCloud(BossModule module) : Components.SimpleAOEs(module, (uint)AID.BlackCloud, 6);
...
class AstralLight(BossModule module) : Components.SimpleAOEs(module, (uint)AID.AstralLight, 6.8f);
