...
public enum AID : uint
{
    ...
    RamsBreath = 1102, // Boss->self, 2.0s cast, range 6+R 120-degree cone, -45 degree offset
    DragonsBreath = 1103, // Boss->self, 2.0s cast, range 6+R 120-degree cone, +45 degree offset
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "veyn", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 12, NameID = 1590)]
