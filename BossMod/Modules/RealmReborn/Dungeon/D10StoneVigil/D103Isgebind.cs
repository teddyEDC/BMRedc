...
class Touchdown(BossModule module) : Components.GenericAOEs(module, ActionID.MakeSpell(AID.Touchdown))
{
    ...
    {
        // TODO: proper timings...
        if (!Module.PrimaryActor.IsTargetable && Module.FindComponent<Cauterize>()!.ActiveCasters.Count == 0)
...
{
    private static readonly Square[] union = [new(new(0, -248), 23.7f), new(new(-23, -259.4f), 1), new(new(3.4f, -271), 1), new(new(12.8f, -225), 1)];
    private static readonly Shape[] difference = [new Square(new(-24, -224), 5.75f, 45.Degrees()), new Square(new(24, -224), 5.75f, 45.Degrees()),
