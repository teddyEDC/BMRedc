...
{
    Boss = 0x4619, // R6.240, x1
    SprightlyStone = 0x461D, // R3.000, x1 (spawn during fight)
    SprightlyMole = 0x461A, // R1.400, x3
    SprightlyLoamkeep = 0x461C, // R2.400, x2
}
...
{
    private static readonly WPos[] vertices = [new(123.42f, -297.25f), new(123.17f, -290.97f), new(123.59f, -290.57f), new(125.10f, -289.46f), new(123.03f, -284.58f),
    new(121.39f, -281.10f), new(121.14f, -280.63f), new(120.20f, -279.18f), new(119.30f, -277.20f), new(118.52f, -276.00f),
    new(117.28f, -273.65f), new(115.34f, -270.32f), new(114.30f, -268.72f), new(113.52f, -266.98f), new(112.45f, -265.22f),
    new(112.24f, -264.61f), new(111.34f, -262.75f), new(110.63f, -261.62f), new(110.14f, -259.81f), new(109.33f, -257.98f),
    new(109.01f, -256.68f), new(108.77f, -256.09f), new(107.10f, -241.10f), new(107.11f, -240.42f), new(107.06f, -239.72f),
    new(106.88f, -238.56f), new(111.77f, -217.52f), new(112.90f, -216.02f), new(112.92f, -215.36f), new(112.69f, -214.67f),
    ...
    new(105.18f, -199.19f), new(103.78f, -199.20f), new(103.51f, -199.81f), new(103.62f, -200.45f), new(103.52f, -201.17f),
    new(103.17f, -201.69f), new(100.93f, -201.86f), new(100.86f, -202.61f), new(100.84f, -204.15f), new(100.49f, -204.52f),
    new(99.91f, -204.60f), new(98.62f, -204.59f), new(98.32f, -205.20f), new(98.31f, -205.94f), new(98.09f, -206.47f),
    ...
    new(89.57f, -243.77f), new(89.92f, -245.80f), new(90.55f, -247.78f), new(91.20f, -250.34f), new(91.70f, -251.59f),
    new(91.97f, -252.89f), new(92.80f, -255.29f), new(93.24f, -257.25f), new(93.95f, -259.21f), new(94.39f, -261.19f),
    new(95.86f, -265.54f), new(96.15f, -266.15f), new(96.98f, -268.72f), new(97.84f, -270.63f), new(104.98f, -283.07f),
    new(105.71f, -284.13f), new(106.00f, -284.66f), new(106.49f, -285.86f), new(107.56f, -287.51f), new(108.05f, -288.70f),
    new(108.36f, -289.32f), new(108.72f, -289.86f), new(108.89f, -290.36f), new(110.23f, -292.79f), new(110.57f, -293.24f),
    new(110.83f, -293.82f), new(111.77f, -295.50f), new(112.26f, -296.71f), new(113.35f, -298.45f), new(113.98f, -298.78f)];
