...
class Landslip(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Landslip, new AOEShapeCone(12, 60.Degrees()));
class Plummet(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Plummet, 10);
