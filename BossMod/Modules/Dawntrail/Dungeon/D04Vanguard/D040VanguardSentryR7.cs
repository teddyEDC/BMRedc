...
{
    private static readonly WPos[] vertices = [new(-90.423f, 263.603f), new(-90.23f, 280.48f), new(-82.081f, 280.704f), new(-82.235f, 288.316f), new(-89.289f, 288.557f), new(-89.909f, 302.169f),
