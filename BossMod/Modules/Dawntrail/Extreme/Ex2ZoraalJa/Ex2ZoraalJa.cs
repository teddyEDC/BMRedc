...
class MultidirectionalDivide(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MultidirectionalDivide, new AOEShapeCross(30f, 2f));
class MultidirectionalDivideMain(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MultidirectionalDivideMain, new AOEShapeCross(30f, 4f));
class MultidirectionalDivideExtra(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MultidirectionalDivideExtra, new AOEShapeCross(40f, 2f));
class RegicidalRage(BossModule module) : Components.TankbusterTether(module, (uint)AID.RegicidalRageAOE, (uint)TetherID.RegicidalRage, 8f);
class BitterWhirlwind(BossModule module) : Components.TankSwap(module, (uint)AID.BitterWhirlwind, (uint)AID.BitterWhirlwindAOEFirst, (uint)AID.BitterWhirlwindAOERest, 3.1f, new AOEShapeCircle(5f), true);
class BurningChains(BossModule module) : Components.Chains(module, (uint)TetherID.BurningChains, (uint)AID.BurningChainsAOE);
