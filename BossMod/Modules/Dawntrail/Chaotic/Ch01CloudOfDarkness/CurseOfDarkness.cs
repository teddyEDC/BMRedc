...
class CurseOfDarkness(BossModule module) : Components.CastCounter(module, (uint)AID.CurseOfDarknessAOE);

class DarkEnergyParticleBeam(BossModule module) : Components.GenericBaitAway(module, (uint)AID.DarkEnergyParticleBeam)
{
