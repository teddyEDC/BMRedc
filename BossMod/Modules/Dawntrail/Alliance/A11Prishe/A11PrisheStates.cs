...
//         Cast(id + 0x100, AID.HolyVisual, 4.4f, 4)
//             .ActivateOnEnter<Holy>();
...
//             .ActivateOnEnter<AsuranFists>();
//         ComponentCondition<AsuranFists>(id + 0x10, 0.5f, comp => comp.Towers.Count > 0, "Tower start");
//         ComponentCondition<AsuranFists>(id + 0x20, 8.3f, comp => comp.Towers.Count == 0, "Tower resolve");
//     }
// }
