...
public enum AID : uint
{
    ...
    DamningStrikesVisual3 = 42053, // Boss->self, no cast, single-target
    DamningStrikesVisual4 = 42055, // Boss->location, no cast, single-target
    DamningStrikesVisual5 = 40794, // Boss->location, no cast, single-target
    DamningStrikesVisual6 = 41054, // Boss->self, 8.7s cast, single-target
    DamningStrikesVisual7 = 42054, // Boss->location, no cast, single-target
    Shockwave = 41112, // Helper->self, no cast, range 100 circle, tower explode
