...
class WaterIIIBait(BossModule module) : Components.BaitAwayTethers(module, new AOEShapeCircle(8f), (uint)TetherID.WaterIII, (uint)AID.WaterIII, (uint)OID.FeatherRay, 7.3f, true);
