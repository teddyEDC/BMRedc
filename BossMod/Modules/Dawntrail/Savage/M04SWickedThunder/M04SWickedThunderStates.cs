...
class M04SWickedThunderStates : StateMachineBuilder
{
    ...
    private void SinglePhase(uint id)
    {
        ...
        ActorCast(id + 0x1E0000, _module.BossP2, (uint)AID.Enrage, 9, 10, true, "Enrage");
    }

    private void WrathOfZeus(uint id, float delay)
    {
        Cast(id, (uint)AID.WrathOfZeus, delay, 5, "Raidwide")
            .SetHint(StateMachine.StateHint.Raidwide);
    }

    private void WickedJolt(uint id, float delay)
    {
        Cast(id, (uint)AID.WickedJolt, delay, 5)
    ...
    {
        CastMulti(id, [(uint)AID.BewitchingFlightR, (uint)AID.BewitchingFlightL], delay, 6)
    ...
    private void ElectrifyingWitchHunt(uint id, float delay)
    {
        ...
        Cast(id + 0x10, (uint)AID.ElectrifyingWitchHunt, 1, 5, "Center/sides")
            .ActivateOnEnter<Electray>()
        ...
        ComponentCondition<ElectrifyingWitchHuntBurst>(id + 0x100, 2.2f, comp => comp.Casters.Count > 0)
            .ActivateOnEnter<ElectrifyingWitchHuntBurst>();
        Cast(id + 0x110, (uint)AID.WitchHunt, 0.9f, 5)
    ...
    {
        CastMulti(id, [(uint)AID.WideningWitchHunt, (uint)AID.NarrowingWitchHunt], delay, 14)
    ...
    {
        Cast(id, (uint)AID.ElectropeEdge, delay, 3);
        Cast(id + 0x10, (uint)AID.ElectropeEdgeWitchgleam, 4.2f, 3)
        ...
        Cast(id + 0x20, (uint)AID.SymphonyFantastique, 0.4f, 3);
    ...
    private void LightningCage(uint id, float delay)
    {
        ...
        Cast(id + 0x10, (uint)AID.LightningCageWitchgleam, 3.2f, 3)
        ...
        Cast(id + 0x20, (uint)AID.LightningCage, 0.4f, 3);
    ...
    {
        CastStart(id, (uint)AID.WickedBolt, delay)
    ...
    {
        CastMulti(id, [(uint)AID.ElectronStream1, (uint)AID.ElectronStream2], delay, 6, $"Side {count}")
    ...
    {
        Cast(id, (uint)AID.ElectropeTransplant, delay, 4);
    ...
    private void PhaseTransition(uint id, float delay)
    {
        ...
        ActorCast(id + 0x30, _module.BossP2, (uint)AID.CrossTailSwitch, 7.2f, 5, true);
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.AzureThunder, delay, 5, true, "Raidwide")
            .OnExit(() => Module.Arena.Bounds = M04SWickedThunder.P2CircleBounds) // at the end of the cast arena changes to circle
            .SetHint(StateMachine.StateHint.Raidwide);
    }

    private void WickedThunder(uint id, float delay)
    {
        ActorCast(id, _module.BossP2, (uint)AID.WickedThunder, delay, 5, true, "Raidwide")
            .OnEnter(() => Module.Arena.Bounds = M04SWickedThunder.P2DefaultBounds) // at the beginning of the cast arena changes back to square
            .SetHint(StateMachine.StateHint.Raidwide);
    }
    ...
    private void Sabertail(uint id, float delay)
    {
        ...
        ActorCast(id + 0x10, _module.BossP2, (uint)AID.WickedBlaze, 2.8f, 5, true);
    ...
    {
        ActorCastMulti(id, _module.BossP2, [(uint)AID.WickedSpecialCenter, (uint)AID.WickedSpecialSides], delay, 5, true)
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.MustardBomb, delay, 8, true)
    ...
    {
        ActorCastStartMulti(id, _module.BossP2, [(uint)AID.TailThrust1HitL, (uint)AID.TailThrust1KnockbackL, (uint)AID.TailThrust1HitR, (uint)AID.TailThrust1KnockbackR], delay, true)
    ...
    {
        ActorCastMulti(id, _module.BossP2, [(uint)AID.AetherialConversionHitLR, (uint)AID.AetherialConversionKnockbackLR, (uint)AID.AetherialConversionHitRL, (uint)AID.AetherialConversionKnockbackRL], delay, 7, true)
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.TwilightSabbath, delay, 3, true);
        ComponentCondition<TwilightSabbath>(id + 2, 3.2f, comp => comp.AOEs.Count > 0)
            .ActivateOnEnter<TwilightSabbath>();
        ActorCast(id + 0x10, _module.BossP2, (uint)AID.WickedFire, 1.0f, 4, true);
        ...
        ActorCastMulti(id + 0x40, _module.BossP2, [(uint)AID.WickedSpecialCenter, (uint)AID.WickedSpecialSides], 1.1f, 5, true)
            .ActivateOnEnter<WickedSpecialCenter>()
            .ActivateOnEnter<WickedSpecialSides>();
    ...
    {
        ActorCast(id, _module.BossP2, (uint)AID.MidnightSabbath, delay, 3, true);
        ComponentCondition<MidnightSabbath>(id + 2, 3.2f, comp => comp.AOEs.Count > 0)
            .ActivateOnEnter<MidnightSabbath>();
        ActorCastMulti(id + 0x10, _module.BossP2, [(uint)AID.ConcentratedBurst, (uint)AID.ScatteredBurst], 1.0f, 7, true)
        ...
        ActorCastStartMulti(id + 0x30, _module.BossP2, [(uint)AID.WickedSpecialCenter, (uint)AID.WickedSpecialSides], 3.1f, true);
    ...
    private void FlameSlash(uint id, float delay)
    {
        ActorCastMulti(id, _module.BossP2, [(uint)AID.AetherialConversionHitLR, (uint)AID.AetherialConversionKnockbackLR, (uint)AID.AetherialConversionHitRL, (uint)AID.AetherialConversionKnockbackRL], delay, 7, true)
            .ActivateOnEnter<AetherialConversion>();
        ActorCast(id + 0x10, _module.BossP2, (uint)AID.FlameSlash, 3.1f, 6, true)
            .ActivateOnEnter<FlameSlash>();
        ComponentCondition<FlameSlash>(id + 0x12, 1, comp => comp.NumCasts > 0, "Destroy center")
            .OnExit(() => Module.Arena.Bounds = M04SWickedThunder.P2TowersBounds);
        ActorCast(id + 0x20, _module.BossP2, (uint)AID.RainingSwords, 2.2f, 2, true)
        ...
        ActorCast(id + 0x30, _module.BossP2, (uint)AID.ChainLightning, 4.2f, 16, true)
        ...
        ComponentCondition<FlameSlash>(id + 0x50, 1, comp => !comp.SmallArena, "Restore center")
            .OnExit(() => Module.Arena.Bounds = M04SWickedThunder.P2DefaultBounds)
    ...
    private void SunriseSabbath(uint id, float delay)
    {
        ...
        ActorCast(id + 0x20, _module.BossP2, (uint)AID.SunriseSabbathIonCluster, 3.2f, 3, true)
            .ActivateOnEnter<SunriseSabbath>(); // buffs appear ~0.8s after cast end
        ActorCast(id + 0x30, _module.BossP2, (uint)AID.SunriseSabbath, 3.2f, 3, true);
        ...
        ComponentCondition<SunriseSabbathElectronStream>(id + 0x81, 0.5f, comp => comp.NumCasts > 4, "Baits 2")
            ...
            .OnExit(() => Module.Arena.Bounds = M04SWickedThunder.P2DefaultBounds); // restore bounds (set to circle by azure thunder)
        AetherialConversionResolve(id + 0x90, 0.9f, true);
    }

    private void SwordQuiver(uint id, float delay)
    {
        ActorCastMulti(id, _module.BossP2, [(uint)AID.SwordQuiverN, (uint)AID.SwordQuiverC, (uint)AID.SwordQuiverS], delay, 5, true)
