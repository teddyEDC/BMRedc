...
class AetherialConversionTailThrust(BossModule module) : Components.GenericAOEs(module, (uint)AID.TailThrust)
{
...
class AetherialConversionSwitchOfTides(BossModule module) : Components.GenericKnockback(module, (uint)AID.SwitchOfTides, true)
{
    private readonly AetherialConversion? _comp = module.FindComponent<AetherialConversion>();
