...
class TempestuousTear(BossModule module) : Components.LineStack(module, aidMarker: (uint)AID.TempestuousTearTargetSelect, (uint)AID.TempestuousTearAOE, 5f, 100f, 3f, 1, 4);
class Overshadow(BossModule module) : Components.LineStack(module, aidMarker: (uint)AID.OvershadowTargetSelect, (uint)AID.OvershadowAOE, 5.1f, 100f, 2.5f, 7, 8);
