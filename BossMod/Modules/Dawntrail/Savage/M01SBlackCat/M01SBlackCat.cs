...
class Overshadow(BossModule module) : Components.LineStack(module, ActionID.MakeSpell(AID.OvershadowTargetSelect), ActionID.MakeSpell(AID.OvershadowAOE), 5.1f, 100, 2.5f, 1, 4);
...
public class M01SBlackCat(WorldState ws, Actor primary) : BossModule(ws, primary, ArenaChanges.ArenaCenter, ArenaChanges.DefaultBounds);
