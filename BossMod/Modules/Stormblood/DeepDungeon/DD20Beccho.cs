...
class PsychoSquamaAOE(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.PsychoSquama), new AOEShapeCone(53, 45.Degrees()));
class NeuroSquamaLookAway(BossModule module) : Components.CastGaze(module, ActionID.MakeSpell(AID.NeuroSquama));
class FragilityAOE(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.Fragility), 8);
