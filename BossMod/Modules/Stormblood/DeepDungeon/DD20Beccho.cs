...
class PsychoSquamaAOE(BossModule module) : Components.SimpleAOEs(module, (uint)AID.PsychoSquama, new AOEShapeCone(53, 45.Degrees()));
class NeuroSquamaLookAway(BossModule module) : Components.CastGaze(module, (uint)AID.NeuroSquama);
class FragilityAOE(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Fragility, 8);
