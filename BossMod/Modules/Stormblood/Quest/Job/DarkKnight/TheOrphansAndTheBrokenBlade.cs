...
class SpiralHell(BossModule module) : Components.SimpleAOEs(module, (uint)AID.SpiralHell, new AOEShapeRect(40, 2));
...
class ShadowOfDeath(BossModule module) : Components.SimpleAOEs(module, (uint)AID.ShadowOfDeath1, 5);
