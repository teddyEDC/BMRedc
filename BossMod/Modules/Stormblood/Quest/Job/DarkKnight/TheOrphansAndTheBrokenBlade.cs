namespace BossMod.Stormblood.Quest.Job.DarkKnight.TheOrphansAndTheBrokenBlade;
...
class SpiralHell(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.SpiralHell), new AOEShapeRect(40, 2));
...
class ShadowOfDeath(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.ShadowOfDeath1), 5);
