...
class P4ViscousAetheroplasmApply(BossModule module) : Components.Cleave(module, (uint)AID.ViscousAetheroplasmApply, new AOEShapeCircle(2), [(uint)OID.UltimaWeapon], originAtTarget: true);
