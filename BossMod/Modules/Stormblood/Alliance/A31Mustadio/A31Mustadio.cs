...
class LeftHandgonne(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.LeftHandgonne), new AOEShapeCone(30, 105.Degrees()));
class RightHandgonne(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.RightHandgonne), new AOEShapeCone(30, 105.Degrees()));

class SatelliteBeam(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.SatelliteBeam), new AOEShapeRect(30, 15, 15)); // Satellite Beam and Compress can both be shown earleir through tether
