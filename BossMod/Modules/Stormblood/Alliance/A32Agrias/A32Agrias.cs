...
class NorthswainsStrikeEphemeralKnight(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.NorthswainsStrikeEphemeralKnight), new AOEShapeRect(60, 3));
...
class HallowedBoltAOE(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.HallowedBoltAOE), 15);
