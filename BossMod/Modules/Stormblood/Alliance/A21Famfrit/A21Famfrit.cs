...
class DarkeningDeluge(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.DarkeningDeluge), 6);
class Tsunami9(BossModule module) : Components.SimpleKnockbacks(module, ActionID.MakeSpell(AID.Tsunami9), 15, stopAtWall: true, kind: Kind.AwayFromOrigin);
class Materialize(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.Materialize), 6);
class DarkRain2(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.DarkRain2), 8);
