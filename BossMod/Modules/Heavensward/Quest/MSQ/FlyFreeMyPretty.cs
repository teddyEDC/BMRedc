...
class MagitekMissiles(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MagitekMissiles, 15);
class ShrapnelShell(BossModule module) : Components.SimpleAOEs(module, (uint)AID.ShrapnelShell, 6);
class Firebomb(BossModule module) : Components.Voidzone(module, 4, m => m.Enemies(0x1E86DF).Where(e => e.EventState != 7));
...
class Overpower(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Overpower, new AOEShapeCone(6, 45.Degrees()));
class GrandSword(BossModule module) : Components.SimpleAOEs(module, (uint)AID.GrandSword, new AOEShapeCone(21, 60.Degrees()));
class MagitekRay(BossModule module) : Components.SimpleAOEs(module, (uint)AID.MagitekRay, 6);
class GrandStrike(BossModule module) : Components.SimpleAOEs(module, (uint)AID.GrandStrike, new AOEShapeRect(48, 2));
