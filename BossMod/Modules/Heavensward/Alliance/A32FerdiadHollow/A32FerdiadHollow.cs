...
class JestersJig1(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.JestersJig1), 9);

class JestersReap(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.JestersReap), new AOEShapeCone(13.4f, 60.Degrees()));
class JestersReward(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.JestersReward), new AOEShapeCone(31.4f, 90.Degrees()));
...
class AtmosAOE1(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.AtmosAOE1), 20);
class AtmosAOE2(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.AtmosAOE2), 20);
class AtmosDonut(BossModule module) : Components.SimpleAOEs(module, ActionID.MakeSpell(AID.AtmosDonut), new AOEShapeDonut(6, 20));
